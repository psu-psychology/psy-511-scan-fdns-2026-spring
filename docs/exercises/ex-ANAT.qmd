---
title: "Exercise ANAT • Neuroanatomy"
...
canvas_db <- psy_511_vars |>
  dplyr::filter(name == "EX_ANAT_CANVAS") |>
  dplyr::select(value) |>
  as.character()
```
...
If you have time, you might pick one or two of the anatomical structures that you highlighted in [Exercise LVL • Levels/Terms](ex-LVL.qmd) and try to locate them.
...
- Submit a photocopy or image of your outline by **`{r} ex_due`** using the Canvas [dropbox](`{r} canvas_db`)
