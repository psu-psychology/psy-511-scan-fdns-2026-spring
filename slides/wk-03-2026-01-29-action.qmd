...
:::: {.columns}
::: {.column width=50%}
### The middle image in A. depicts what plane of section?
- A. Sagittal
- B. Dorsal
- C. Coronal
- D. Horizontal
...
## Animal movement a function of

- Physics
- Biology
- Psychology

## Movement one result of nervous system output
...
That is, higher levels of the nervous system might learn the relationship between motor neuron output and spindle feedback from "random" activity.
:::
...
![https://www.tobii.com/resource-center/learn-articles/types-of-eye-movements](https://a.storyblok.com/f/149538/01b3d43e55/tobii-eye-movement-fovea.jpg/m/0x0:1500x1000/1200x0/filters:format(webp):quality(80))
