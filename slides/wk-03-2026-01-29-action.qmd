...
## Movement only one type of output
...
### Input and output flow schematic
...
## Topographic organization {.scrollable}
...
:::
::: {.column width=50%}
![By I, Paskari, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=2344159](https://upload.wikimedia.org/wikipedia/commons/8/80/Posterior_Parietal_Lobe.jpg){fig-align="right"}
:::
::::
