...
::: answer
::: incremental
- ~~A. The channels bind a ligand like glutamate.~~ {{< fa circle-xmark >}}
- ~~B. The Na/K pump slows down.~~ {{< fa circle-xmark >}}
- ~~C. Cl- entry causes the cell to hyperpolarize.~~ {{< fa circle-xmark >}} 
- **D. An accumulation of EPSPs depolarizes the membrane.** {{< fa check >}}
:::
:::
:::
...
::: answer
::: incremental
- A. Voltage-gated $Na^+$ channels close and inactivate. {{< fa check >}} 
- B. Voltage-gated $K^+$ channels open. {{< fa check >}} 
- C. $K^+$ ions flow out of the cell through passive/leak channels. {{< fa check >}} 
- **D. The membrane potential approaches the reversal/equilibrium potential for $K^+$.** {{< fa check >}}
:::
:::
::: 
...
::: answer
::: incremental
- A. Large diameter. {{< fa check >}} 
- ~~B. Small diameter.~~ {{< fa circle-xmark >}}
- C. Thick myelin. {{< fa check >}}
- ~~D. Short axon length.~~ {{< fa circle-xmark >}}
-  **E. A and C.** {{< fa check >}}
::: 
:::
:::
...
:::: {.columns}
::: {.column width=50%}
![http://pittmedneuro.com/inhibitory.html](http://pittmedneuro.com/img/GABAa.jpg){width="60%" #fig-gabaa-receptor-pitt}
...
- "...not consistent of there being an association between serotonin and depression..." [@Moncrieff2022-os]
:::
::: {.column width=50%}
...
- 200+ and counting [@UnknownUnknown-pb]

## The chemical brain

:::: {.columns}
::: {.column width=50%}
![giphy.com](https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExOXIzMzI5NjhwYnF6NThub2IydWJqOWJvNm92ZWVqMndpZGw1YWc3MCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/2wRLDz95iZ3YhSn9pK/giphy.gif){width="70%"}
:::
::: {.column width=50%}
![giphy.com](https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExemV4Z2NpOXoxa2hyMW40dWV0dTJ2dWQxZ3pydnoxcGxkNDh3M2VjbSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/wRVWf0rZhggJ7ZQxqb/giphy.gif){width="70%"}
:::
::::
...
- "Output" organ
  - Master gland^[Plus control over ANS]
