...
::: {#fig-gentle-arms-of-eden}
<iframe width="1280" height="450" src="https://www.youtube.com/embed/bAGMATHlSK4?si=S3Sjrt_2r9LdwMCt" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
:::: {.columns}
::: {.column width=40%}
![@Wikipedia-contributors2026-nu^["Mosaic medallion in the floor of the main hall of the Jordan Hall of Science, University of Notre Dame. By SteveMcCluskey - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=25369137."]](https://upload.wikimedia.org/wikipedia/commons/8/80/Dobzhansky_Evolution_Notre_Dame.jpg)
:::
::: {.column width=60%}
...
![Rick Gilmore's family tree](../include/img/gilmore-rick-7-generations.png){#fig-gilmore-family-tree fig-align="center" width="70%"}
...
:::
::: {.column width=50%}
![https://www.britannica.com/science/evolution-scientific-theory](https://cdn.britannica.com/98/398-050-BCA23330/scale-events.jpg){width="50%"}
:::
::::
...
- Bilaterality
  - Simplifies steering?
  - Remember [Braitenberg's Vehicles](wk-03-2026-01-29-action.qmd#/but-simple-circuits)?
:::
::: {.column width=50%}
::: {#fig-nerve-net-video}
...
:::
::: {.column width=50%}
![@Herculano-Houzel2016-oy](https://i.thriftbooks.com/api/imagehandler/m/265B2E0B5A49FB55292E7E064107E17737EE8DA6.jpeg){#fig-herculano-houtzel-2016}
:::
::::

## {.scrollable}

![@Herculano-Houzel2012-up Figure 1^["Large brains appear several times in the mammalian radiation. Example species are illustrated for each major mammalian group. The mammalian radiation is based on the findings of Murphy et al. (18) and Kaas (19). Brain images are from the University of Wisconsin and Michigan State Comparative Mammalian Brain Collections (www.brainmuseum.org)."]](../include/img/herculano-houtzel-2012-fig-01.webp){#fig-herculano-houtzel-2012-fig-01}
...
:::
::: {.column width=50%}
![@Venditti2024-ul Figure 4](../include/img/venditti-2024-fig-04.png){#fig-venditti-2024-fig-04}
...
![@Herculano-Houzel2017-gf Figure 3](https://ars.els-cdn.com/content/image/1-s2.0-S2352154616302637-gr3_lrg.jpg){#fig-herculano-houtzel-2017-fig-03}
...
- Behavior
    - Predator/prey interactions [@Wooster2026-uk]
...
- Cultural factors
  - Social brain [@Dunbar1998-ny]
  - Communication
  - Cooking [@Wrangham2009-vq] then later, agriculture & urbanization
...
:::
::: {.column width=50%}
![@konner_evolution_2011](https://images.bwbcovers.com/067/The-Evolution-of-Childhood-9780674045668.jpg){fig-align="right"}
:::
::::
...
:::
::: {.column width=50%}
![https://www.mayoclinic.org/diseases-conditions/spina-bifida/symptoms-causes/syc-20377860](https://www.mayoclinic.org/-/media/kcms/gbs/patient-consumer/images/2013/08/26/11/10/ds00417_im03493_r7_spinabifidababythu_jpg-popup.jpg){.lightbox width=75% fig-align="center" #fig-spina-bifida}
:::
::::
...
:::: {.columns}
::: {.column width=50%}
![Embryonic human brain from Wikipedia](../include/img/6_week_embryo_brain.jpg){#fig-6-week-embryo}
:::
::: {.column width=50%}
![Cross section of embryonic brain from Wikipedia](https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/EmbryonicBrain.svg/1200px-EmbryonicBrain.svg.png){#fig-embryonic-brain}
:::
::::
...
:::
::: {.column width=50%}
![@Disouky2026-ok](../include/img/disouky-2026-cover.png){#fig-disouky-2026}
:::
::::
...
:::: {.columns}
::: {.column width=50%}
![](../include/img/radial-glia.jpg){.lightbox width=75% fig-align="center" #fig-radial-glia}
:::
::: {.column width=50%}
![](../include/img/neural-tube.jpg){.lightbox width=75% fig-align="center" #fig-neural-tube}
:::
::::

## Radial unit hypothesis

![@Rakic2009-jk Figure 2](https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fnrn2719/MediaObjects/41583_2009_Article_BFnrn2719_Fig2_HTML.jpg?as=webp #fig-rakic-2009-fig-02){#fig-radial-unit-hypothesis}
...
![@johnson2009functional](../include/img/johnson-gene-expression-fig-6.jpeg){width=75% fig-align="center" #fig-johnson-2009-fig-06}
...
:::
::: {.column width=50%}
![@Huttenlocher2009-ez](../include/img/synaptic-density-infant.jpg){.lightbox #fig-huttenlocher-2009-synaptic-density}
:::
::::
...
![@Rakic2009-jk Figure 3](https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fnrn2719/MediaObjects/41583_2009_Article_BFnrn2719_Fig3_HTML.jpg?as=webp){width=75% fig-align="center" #fig-rakic-2009-fig-03}

## Synaptic rearrangement

:::: {.columns}
::: {.column width=50%}
![Huttenlocher](../include/img/huttenlocher.jpg){width=75% fig-align="center" #fig-huttenlocher}
:::
::: {.column width=50%}
...
::: {.column width=50%}
#### Synaptogenesis
![](../include/img/huttenlocher.jpg){#fig-huttenlocher-growth}
:::
::: {.column width=50%}
#### Myelination
![@Hagmann02112010 Figure 1](https://www.pnas.org/cms/10.1073/pnas.1009073107/asset/ff27c87e-3ed0-4a67-96a2-19ec4ea4c327/assets/graphic/pnas.1009073107fig01.jpeg){#fig-hagmann-dti-data}
:::
::::
...
![@Petrican2017-re Figure 2a](https://ars.els-cdn.com/content/image/1-s2.0-S1053811917307735-gr2a_lrg.jpg){#fig-petrican-2017-fig-02a}

## "Control" networks {.scrollable}

![@Petrican2017-re Figure 2b](https://ars.els-cdn.com/content/image/1-s2.0-S1053811917307735-gr2b_lrg.jpg){#fig-petrican-2017-fig-02b}

## Non-"control" networks {.scrollable}

![@Petrican2017-re Figure 2c](https://ars.els-cdn.com/content/image/1-s2.0-S1053811917307735-gr2c_lrg.jpg){#fig-petrican-2017-fig-02c}


## Developmental connectomics

![@Cao2017-bl^["Hypothetical Models of Brain Connectome Development from Infancy to Early Childhood (A) A hypothetical developmental model of information segregation and integration in the brain networks. (C) A hypothetical developmental model from primary regions to higher-order association regions. (C) A hypothetical developmental model of structural and functional brain connectomes."]](../include/img/cao-2017.jpg){#fig-cao-2017-fig-a}
...
:::
::: {.column width=50%}
![@Shaw2008-dq Figure 1](http://www.jneurosci.org/content/jneuro/28/14/3586/F1.large.jpg){width="75%" #fig-shaw-2008-fig-01}
:::
::::
...
:::: {.columns}
::: {.column width=50%}
![@Shaw2008-dq Figure 2](http://www.jneurosci.org/content/jneuro/28/14/3586/F2.large.jpg){#fig-shaw-2008-fig-02}

:::
::: {.column width=50%}
![@Shaw2008-dq Figure 3](http://www.jneurosci.org/content/jneuro/28/14/3586/F3.large.jpg){#fig-shaw-2008-fig-03}
:::
::::

## {.scrollable}

![@Shaw2008-dq Figure 4](http://www.jneurosci.org/content/jneuro/28/14/3586/F4.large.jpg){width="50%" #fig-shaw-2008-fig-04}
...
![@swanson2012brain](../include/img/swanson-1.jpg){#fig-swanson-2012-01}

## 4 weeks

![https://upload.wikimedia.org/wikipedia/commons/4/4c/4_week_embryo_brain.jpg](https://upload.wikimedia.org/wikipedia/commons/4/4c/4_week_embryo_brain.jpg){#fig-wikimedia-embryo}

## ~4 weeks

![@swanson2012brain](../include/img/swanson-2.jpg){#fig-swanson-2012-02}

## 6 weeks

:::: {.columns}
::: {.column width=50%}
![https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/6_week_human_embryo_nervous_system.svg/500px-6_week_human_embryo_nervous_system.svg.png](https://upload.wikimedia.org/wikipedia/commons/thumb/3/33/6_week_human_embryo_nervous_system.svg/500px-6_week_human_embryo_nervous_system.svg.png){#fig-wikimedia-6-week-embryo}
:::
::: {.column width=50%}
![@swanson2012brain](../include/img/swanson-3.jpg){#fig-swanson-2012-3}
:::
::::

## Beyond 6 weeks

![@swanson2012brain](../include/img/swanson-4.jpg){#fig-swanson-2012-4}
