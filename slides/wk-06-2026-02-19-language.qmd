...
::: {#fig-nonsense-song}
<iframe width="1200" height="450" src="https://www.youtube.com/embed/RObuKTeHoxo?si=haQjjf4iNhiYGluM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
::: {#fig-fast-talker-video}
<iframe width="1200" height="450" src="https://www.youtube.com/embed/4X4Fy8YqysY?rel=0&amp;start=160" frameborder="0" allowfullscreen></iframe>
...
- Speech sounds $\rightarrow$ words
  - ifyoudidnotknowtheenglishlanguagethiswould
    beanincomprehensiblestreamoflettersorsounds
...
- [Ludvig Lichtheim](https://en.wikipedia.org/wiki/Ludwig_Lichtheim)
- [Norman Geschwind](https://en.wikipedia.org/wiki/Norman_Geschwind)
:::
::: {.column width=50%}
![@Tremblay2016-gm Figure 1^["Fig. 1. Left: The original model from Wernicke, 1874. For unknown reasons, the model is represented on the right hemisphere. Right: An update of the Classic model from Geschwind, 1972. In this figure, according to most anatomical definitions, the superior temporal gyrus is inadvertently mislabeled as the angular gyrus."]](https://ars.els-cdn.com/content/image/1-s2.0-S0093934X16300475-gr1_lrg.jpg)
:::
::::
...
:::: {.columns}
::: {.column width=50%}
- [Superior Temporal Gyrus (STG)](https://en.wikipedia.org/wiki/Superior_temporal_gyrus): Comprehension
- [Inferior Frontal Gyrus (IFG)](https://en.wikipedia.org/wiki/Inferior_frontal_gyrus): Speech articulation 
:::
::: {.column width=50%}
...
::: {#fig-video-wernickes}
<iframe width="1200" height="450" src="https://www.youtube.com/embed/dKTdMV6cOZw?si=iSPljaQTUhqHEqrk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Illustration of Wernicke's aphasia [@cogmonaut2010-hc]
:::
...
::: {#fig-video-brocas}
<iframe width="1200" height="450" src="https://www.youtube.com/embed/f2IiMEbMnPM?si=Q8SijoleIHB876XV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

Illustration of Broca's aphasia [@purepedantry2007-td]
:::
...
:::: {.columns}
::: {.column width=50%}
![@Tremblay2016-gm](../include/img/tremblay-dick-2016.png)
:::
::: {.column width=50%}
...
![@Unknown2025-zs](../include/img/kandemir-2025-ai-energy.png)
...
::: {#fig-deaf-speakers-google-questions}
<iframe width="1200 height="450" src="https://www.youtube.com/embed/IgmB9c29UKU?si=aSViHzbK0w6Za49u" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

@BuzzFeedVideo2019-oq
:::
