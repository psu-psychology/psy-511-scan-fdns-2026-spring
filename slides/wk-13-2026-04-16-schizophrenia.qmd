---
title: "Bipolar Disorder & Schizophrenia"
format: revealjs
---
...
<iframe width="972" height="567" src="https://www.youtube.com/embed/UIt3dx4an9c?si=3N5WUyxJaXxdeAPr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
:::
::: {.column width=60%}
![Source: NIMH](../include/img/nih-bipolar-table.jpg){height="80%"}
:::
::::

## Background on BP

- 1-3% lifetime prevalence, subthreshold affects another ~2% [@Merikangas2007-hu]
- Subtypes
...
![@Bourque2024-rw](../include/img/bourque-fig-02.png){#fig-bourque-2024 width="60%"}
...
![@Pettersson2019-io Figure 1](../include/img/pettersson-fig-01.png){#fig-pettersson-2019-fig-01}
...
:::
::: {.column width=50%}
![@Maletic2014-oe Figure 2](https://www.frontiersin.org/files/Articles/89757/fpsyt-05-00098-HTML/image_m/fpsyt-05-00098-g002.jpg){#fig-maletic-2014-fig-02}
:::
::::
...
:::
::: {.column width=50%}
![@Ching2022-of Figure 4a](../include/img/ching-2022-fig-04a.png){#fig-ching-2022-fig-04a}
:::
::::

---

![@Ching2022-of Figure 5](../include/img/ching-2022-fig-05.png){#fig-ching-2022-fig-05}
...
:::
::: {.column width=50%}
![@Ching2022-of Figure 7](../include/img/ching-2022-fig-07.png){#fig-ching-2022-fig-07}
:::
::::

## Toward a unified model

![@Magioncalda2022-ic Figure 2.](https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fs41380-021-01091-4/MediaObjects/41380_2021_1091_Fig1_HTML.png?as=webp){#fig-macioncalda-2022-fig-02}
...
![@Bi2022-ag Figure 1^["Major challenges facing neuroimaging studies of BD and how the ENIGMA BD Working Group meets these challenges"]](https://onlinelibrary.wiley.com/cms/asset/3707c442-2507-4d6e-b544-80a91ed113fb/hbm25098-fig-0001-m.jpg){#fig-bi-2022-fig-01}
...
::: {#fig-gerald-video}
<iframe width="972" height="567" src="https://www.youtube.com/embed/gGnl8dqEoPQ?si=z3vM1hHYmc8MV63B" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
::: {#fig-vr-video}
<iframe width="972" height="567" src="https://www.youtube.com/embed/YXimT5CHCDE?si=zLaovjTYosKnUbE1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

@TheMentallight2010-ea
:::
...
![@Van_Os2009-be Figure 1^["Principles underlying the main distinction between affective psychosis (eg, bipolar disorder and psychotic depression) and non-affective psychosis (eg, schizophrenia and schizophreniform disorder)."]](https://ars.els-cdn.com/content/image/1-s2.0-S0140673609609958-gr1_lrg.jpg){#fig-van-os-2009-fig-01 width="60%"}

---

![@Van_Os2009-be Figure 2^["Three hypothetical typical patients diagnosed with a combination of categorical and dimensional representations of psychopathology. Categorical diagnoses of schizophrenia (blue), bipolar disorder (green), and schizoaffective disorder (violet) are accompanied by a patient's quantitative scores (connected by red lines) on five main dimensions of psychopathology."]](https://ars.els-cdn.com/content/image/1-s2.0-S0140673609609958-gr2_lrg.jpg){#fig-van-os-2009-fig-02 width="60%"}
...
:::
::: {.column width=50%}
![@Johnson2017-bp](../include/img/johnson-etal-2017-schiz.jpg){#fig-johnson-2017}
:::
::::

## Ventricles larger, esp in males

![@Suddath1990-nn Figure 2^["MRI Coronal Views from Two Sets of Monozygotic Twins Discordant for Schizophrenia Showing Subtle Enlargement of the Lateral Ventricles in the Affected Twins (Panels B and D) as Compared with the Unaffected Twins (Panels A and C), Even When the Affected Twin Had Small Ventricles."]](../include/img/schizophrenia-ventricles.jpg)

## Enlargement increases across time

:::: {.columns}
::: {.column width=50%}
![@Davis1998-ki Figure 2](https://ars.els-cdn.com/content/image/1-s2.0-S0006322397005532-gr2.gif){#fig-davis-1998-fig-02}
:::
::: {.column width=50%}
![@Davis1998-ki Figure 3](https://ars.els-cdn.com/content/image/1-s2.0-S0006322397005532-gr3.gif){#fig-davis-1998-fig-03}
:::
::::
...
:::
::: {.column width=50%}
![@Van_Erp2015-ne Figure 1](https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fmp.2015.63/MediaObjects/41380_2016_Article_BFmp201563_Fig1_HTML.jpg?as=webp){#fig-van-erp-2015-fig-01}
:::
::::

## White matter disruption {.scrollable}

![@Kelly2017-lj](https://media.springernature.com/full/springer-static/image/art%3A10.1038%2Fmp.2017.170/MediaObjects/41380_2018_Article_BFmp2017170_Fig1_HTML.jpg?as=webp){#fig-kelly-2017-fig-01}

## White matter loss over age

![@Kochunov2016-cu Figure 2](../include/img/hbm23336-fig-0002-m.jpg){#fig-kochunov-fig-02 width="60%"}
...
![@Uhlhaas2013-do](https://ars.els-cdn.com/content/image/1-s2.0-S0959438812001663-gr1.jpg){#fig-uhlhaas-2013-fig-01 width="40%"}
...
![](../include/img/mesolimbocortical-da.jpg){width="60%" fig-align="center"}
...
:::
::: {.column width=50%}
![@Sleigh2014-xp](https://ars.els-cdn.com/content/image/1-s2.0-S2210844014200062-gr1.jpg){#fig-sleigh-2014-fig-01}
:::
::::
...
:::
::: {.column width=50%}
![@Sleigh2014-xp](https://ars.els-cdn.com/content/image/1-s2.0-S2210844014200062-gr1.jpg)
:::
::::
