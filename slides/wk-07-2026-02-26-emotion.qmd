...
- 6,706 J/query = 1.86 Wh/query. Brain uses ~20 W, so...
  - 100 x 1.86/20= `{r} 100*1.86/20` % of a typical human brain's energy budget
- Training: ~1,000 MWh or 1e6/20 = `{r} 1e6/20` human brain budgets
