...
:::
::: {.column width=50%}
![Wikipedia](https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Microglia_and_neurons.jpg/1200px-Microglia_and_neurons.jpg){#fig-microglia}
:::
::::
...
:::
::: {.column width=50%}
![Wikipedia](https://upload.wikimedia.org/wikipedia/commons/b/b1/Dendritic_spines.jpg){#fig-dendritic-spines}
:::
::::
...
:::
::: {.column width=50%}
![Pyramidal cell (Wikipedia)](https://upload.wikimedia.org/wikipedia/commons/6/6d/GolgiStainedPyramidalCell.jpg){fig-align="right" width="70%" #fig-pyramidal-cell}
:::
::::
