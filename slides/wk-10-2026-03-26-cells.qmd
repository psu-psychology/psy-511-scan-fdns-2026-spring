...
- *Due*: [Exercise EVO • Evolution](../exercises/ex-EVO.qmd)
...
![https://www.britannica.com/science/evolution-scientific-theory](https://cdn.britannica.com/98/398-050-BCA23330/scale-events.jpg){#fig-geologic-timeline}

---

::: {#fig-to-scale}
<iframe width="1280" height="450" src="https://www.youtube.com/embed/nOVvEbH2GC0?si=vmbDk3QFLL0p2maJ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
:::: {.columns}
::: {.column width=50%}
![@Eckert2024-hd](../include/img/eckert-etal-2024.png){#fig-eckert-2024}
:::
::: {.column width=50%}
![@Rajan2023-wr](../include/img/rajan-2023.png){#fig-rajan-2023}
:::
::::
...
:::: {.columns}
::: {.column width=50%}
![@Sterling2021-yx](https://mit-press-new-us.imgix.net/covers/9780262534680.jpg?auto=format&w=298&dpr=2&q=80){width=60% #fig-sterling-2021}
:::
::: {.column width=50%}
...
:::
::: {.column width=50%}
![@azevedo2009equal Figure 2](../include/img/azevedo-et-al-fig-1.jpg){#fig-azevedo-2009}
:::
::::
...
:::
::: {.column width=50%}
![Wikipedia ^[Neuron (yellow), astrocyte (green), oligodendrocyte (blue), microglia (reddish brown)]](https://upload.wikimedia.org/wikipedia/commons/c/ca/Glial_Cell_Types.png){width="60%" fig-align="right" #fig-wikipedia-neurons}
:::
::::
...
:::
::: {.column width=50%}
![https://en.wikipedia.org/wiki/Astrocyte](https://upload.wikimedia.org/wikipedia/commons/5/56/Human_astrocyte.png){fig-align="right" #fig-astrocyte}
:::
::::
...
:::
::: {.column width=50%}
![https://en.wikipedia.org/wiki/Astrocyte](https://upload.wikimedia.org/wikipedia/commons/3/3e/Metabolic_interactions_between_astrocytes_and_neurons_with_major_reactions.png){#fig-astrocyte-neuron-signalling}
:::
::::
...
![https://en.wikipedia.org/wiki/Astrocyte](https://upload.wikimedia.org/wikipedia/commons/3/3e/Metabolic_interactions_between_astrocytes_and_neurons_with_major_reactions.png){width="80%"}
...
:::
::: {.column width=50%}
![https://www.hydroassoc.org/grey-matter-brain-damage/](https://www.hydroassoc.org/wp-content/uploads/2015/01/MatterInjury.jpg)
:::
::::
...
:::
::: {.column width=50%}
![https://www.brainfacts.org/brain-anatomy-and-function/cells-and-circuits/2018/schwann-cells-keep-signals-strong-012918](https://www.brainfacts.org/-/media/Brainfacts2/Brain-Anatomy-and-Function/Cells-and-Circuits/Article-Images/012918-IOTW.png){#fig-schwann-cell-1}
:::
::::

---

![https://en.wikipedia.org/wiki/Schwann_cell](https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Neuron_Hand-tuned.svg/1920px-Neuron_Hand-tuned.svg.png){#fig-schwann-cell-2 width="60%"}
...
:::
::: {.column width=50%}
![@Wikipedia-contributors2025-do^["Rat microglia grown in tissue culture in green, along with nerve fiber processes shown in red. By GerryShaw - Own work, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=17504964. "]](https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Microglia_and_neurons.jpg/1200px-Microglia_and_neurons.jpg){#fig-microglia}
:::
::::
...
:::
::: {.column width=50%}
![@Wikipedia-contributors2025-do](https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Microglia_and_neurons.jpg/1200px-Microglia_and_neurons.jpg)
:::
::::

## [Neurons](https://en.wikipedia.org/wiki/Neuron)

![Neurons in mouse hippocampus: http://www.extremetech.com/wp-content/uploads/2012/03/a-mouse-hippocampus-640x353.jpg](http://www.extremetech.com/wp-content/uploads/2012/03/a-mouse-hippocampus-640x353.jpg){#fig-neurons-hipp}
...
:::
::: {.column width=50%}
![Wikipedia](https://upload.wikimedia.org/wikipedia/commons/thumb/a/a9/Complete_neuron_cell_diagram_en.svg/1280px-Complete_neuron_cell_diagram_en.svg.png){#fig-neuron-schematic}
:::
::::
...
:::
::: {.column width=50%}
![https://askabiologist.asu.edu/neuron-anatomy](https://askabiologist.asu.edu/sites/default/files/resources/articles/neuron_anatomy.jpg){#fig-neuron-direction-messages-travel}
:::
::::
...
:::
::: {.column width=50%}
![@Wikipedia-contributors2025-py^["Spines on the dendrite of a medium spiny striatal neuron. The image was obtained by expressing Enhanced Green Fluorescent Protein (EGFP) in the neurons and imaging them using a laser scanning two photon microscope. By http://en.wikipedia.org/w/index.php?title=User:Tmhoogland&action=edit - http://en.wikipedia.org/wiki/Image:Spines.jpg, Public Domain, https://commons.wikimedia.org/w/index.php?curid=1826453"]](https://upload.wikimedia.org/wikipedia/commons/b/b1/Dendritic_spines.jpg){#fig-dendritic-spines}
:::
::::
...
- Nucleus
	+ Chromosomes
	- 70-84% of human genes expressed in the brain [@Negi2017-vh]
:::
::: {.column width=50%}
...
:::
::: {.column width=50%}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Blausen_0657_MultipolarNeuron.png/1920px-Blausen_0657_MultipolarNeuron.png){#fig-schematic-neuron}
:::
::::
...
:::
::: {.column width=50%}
![@Wikipedia-contributors2025-np](https://upload.wikimedia.org/wikipedia/commons/3/3b/Nodes_of_Ranvier.png){fig-align="right" #fig-schematic-neuron}
:::
::::
...
:::
::: {.column width=50%}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/9/92/Neurons_uni_bi_multi_pseudouni.svg/2000px-Neurons_uni_bi_multi_pseudouni.svg.png){#fig-neuron-anatomy}
:::
::::
...
::: {.column width=50%}
![Illustration of kinetic and potential energy](http://physics20project.weebly.com/uploads/1/6/4/8/16484122/1358825569.png){#fig-potential-energy}
:::
::::
...
![Simple circuit schematic](https://ka-perseus-images.s3.amazonaws.com/16b4aecbaae9e2a5e0b50fc70ace724f471ad0c0.svg){#fig-simple-circuit}
:::
::::
...
:::
::: {.column width=50%}
![How capacitors work; http://hyperphysics.phy-astr.gsu.edu/hbase/electric/imgele/capchg.png](../include/img/capchg.png){#fig-capacitors}
:::
::::
...
:::
::: {.column width=50%}
![Measuring the resting potential.](http://www.physiologyweb.com/lecture_notes/resting_membrane_potential/figs/measuring_the_membrane_potential_w.jpg){#fig-membrane-potential}
:::
::::
...
:::
::: {.column width=50%}
![Types of ion channels.](https://www.news-medical.net/image-handler/ts/20181025104435/ri/673/picture/2018/10/shutterstock_480412786.jpg)
:::
::::
...
:::
::: {.column width=50%}
![Sodium/potassium "pump", @Wikipedia-contributors2026-vp](https://upload.wikimedia.org/wikipedia/commons/8/89/0308_Sodium_Potassium_Pump.jpg)
:::
::::
...
- Nernst equation^[Note that the outside/inside concentration ratio < 1. The log of a number < 1 is negative.]
:::
::: {.column width=50%}
![Nernst equation, www.physiologyweb.com](http://www.physiologyweb.com/lecture_notes/resting_membrane_potential/figs/nernst_equation_v_k.gif)
:::
::::
...
::: {.callout-important}
## Your turn
- Resting potential is -60-70 mV, more *positive* than the -90 mV that would stop $K^+$ outflow
- Why?
:::
:::
...
![Tug-o-war illustrating a balance among forces.](https://cdn.britannica.com/73/124073-050-8CA8D40F/Tug-of-war-US-Naval-Academy-Maryland-Annapolis-2005.jpg)
...
![](https://m.media-amazon.com/images/I/71ejRBpSyWL._AC_SY879_.jpg){fig-align="center" width="40%"}
